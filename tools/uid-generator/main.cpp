...
int main(int argc, char* argv[])
{
    ...
    QApplication::setApplicationName(QStringLiteral("uid-generator"));
    QApplication::setApplicationVersion(QStringLiteral("1.0"));

    QCommandLineParser parser;
    parser.setApplicationDescription(
        QStringLiteral("Generate collision-free structured UIDs."));
    ...
    const QCommandLineOption smoke_test_option(
        ...
        QStringLiteral("Run an automated GUI and collision-guard check, then exit."));
    ...
    symulator::tools::uid_generator::MainWindow window(data_directory);
