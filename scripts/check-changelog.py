...
Cross-platform manual pre-commit check.
Run this before committing if your Git client does not fire shell hooks (e.g. GitHub
Desktop or TortoiseGit on Windows):
...
def main() -> int:
    ...
    if ver is None:
        errors.append(
            ...
            f"  Add a line like:  ## [0.2.9] — (today's date)"
        )
